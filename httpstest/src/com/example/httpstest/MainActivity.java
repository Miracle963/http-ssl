...
public class MainActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    new Thread(new Runnable() {
      ...
      public void run() {
        try {
        //	initSSL();//HttpUrlConnection 方式，支持指定load-der.crt证书验证，此种方式Android官方建议
        	//initSSLALL();//HttpUrlConnection支持所有Https免验证，不建议使用
//  	initSSLAllWithHttpClient();//HttpClient方式实现，支持所有Https免验证方式链接
        	initSSLCertainWithHttpClient();//HttpClient方式实现，支持验证指定证书
        } catch (Exception e) {
